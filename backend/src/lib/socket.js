...
io.on("connection", (socket) => {
  ...
  socket.on("logout", () => {
    const logoutUserId = socket.userId;

    console.log("\n================================");
    console.log("LOGOUT REQUEST RECEIVED");
    console.log("User:", logoutUserId);
    console.log("================================");
    ...
    const userSockets = userSocketMap.get(logoutUserId);

    if (!userSockets || userSockets.size === 0) {
      console.log("No active sockets for:", logoutUserId);
    ...
    */
    ...
    const socketsToDisconnect = [...userSockets];
  ...
  socket.on("disconnect", (reason) => {
    ...
    const userSockets = userSocketMap.get(
      disconnectedUserId
    );
